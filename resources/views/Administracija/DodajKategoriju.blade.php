...
<body>
    <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('DodavanjeKategorije')}}">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <div class="col-md-4 col-form-label text-md-right"><label for="naziv">Naziv Kategorije</label></div>
                            <div class="col-md-6"><input type="text" name="naziv" class=" form-control" placeholder="Unesite naziv kategorije" id="naziv"/></div>
                        </div>
                        ...
                        <div class="form-group row">    
                            ...
                            <div class="col-md-6">
                                <input type="submit" class="btn btn-success form-control" onclick="return proveri();" value="Dodaj kategoriju"/>
                            </div>
                        </div>
                    </form>
                </div>
